...
class Spaceship(SpaceObject):
    ...
    def __init__(self, sprite, x ,y):
        ...
        flame_sprite = pyglet.image.load("![](Assetss/PNG/Lasers/laserBlue01.png)")
    ...
    """
    def shoot(self):
        img = pyglet.image.load("![](Assetss/PNG/Lasers/laserBlue01.png)")
    ...
    def tick(self, dt):
        ...
        if "SPACE" in pressed_keyboards and self.laser_ready:
            ...
            pyglet.clock.schedule_once(self.reload, delay_strelba)
